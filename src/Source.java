...
public class Source {
  public static void main(String[] args) {
    ...
    System.out.println("Insertion Sort = " + (InsSortedEnd - InsSortedStart)
        + "ms  Selection Sort = " + (SelSortedEnd - SelSortedStart) + "ms  Bubble Sort = "
        + (BubSortedEnd - BubSortedStart) + "ms");
    System.out.println("Merge Sort = " + (MerSortedEnd - MerSortedStart) + "ms  Quick Sort = "
        + (QuiSortedEnd - QuiSortedStart) + "ms  Heap Sort = " + (HeapSortedEnd - HeapSortedStart)
        + "ms");
    System.out.println();
    System.out.println("Execution Times For Reverse Order Numbers : ");
    System.out.println("Insertion Sort = " + (InsRevEnd - InsRevStart) + "ms  Selection Sort = "
        + (SelRevEnd - SelRevStart) + "ms  Bubble Sort = " + (BubRevEnd - BubRevtart) + "ms");
    System.out.println("Merge Sort = " + (MerRevEnd - MerSRevtart) + "ms  Quick Sort = "
        + (QuiRevdEnd - QuiRevStart) + "ms  Heap Sort = " + (HeapRevEnd - HeapRevStart) + "ms");
    System.out.println();
    System.out.println("Execution Times For Random Number : ");
    System.out.println("Insertion Sort = " + (InsRandomEnd - InsRandomStart)
        + "ms  Selection Sort = " + (SelRandomEnd - SelRandomStart) + "ms  Bubble Sort = "
        + (BubRandomEnd - BubRandomStart) + "ms");
    System.out.println("Merge Sort = " + (MerRandomEnd - MerRandomStart) + "ms  Quick Sort = "
        + (QuiRandomEnd - QuiRandomStart) + "ms  Heap Sort = " + (HeapRandomEnd - HeapRandomStart)
        + "ms");
